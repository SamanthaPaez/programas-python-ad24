# p139-ventas - Aplicacion orientada a objetos que simula las ventas de una tienda 
...
class Cliente:
    ...
    def totalVentas(self):
        ...
        return total
    def __str__(self):
        return f"Cliente [Nombre: {self.nombre:<15} RFC: {self.rfc:<12} Domicilio: {self.domicilio:<20} Correo: {self.correo:<20}] - Total Ventas: {self.totalVentas():,.2f}"    
...
def main():
    ...
    mitienda.agregarCliente(Cliente("CARC711202","Carlos Castaneda", "Av Mexico 115", "castr@uaz.edu.mx"))
    ...
    mitienda.agregarCliente(Cliente("SOBR731123", "Rocio Soto", "Sierra Tecuan 345", "rocio@gmail.com"))
